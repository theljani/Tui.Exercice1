...
namespace TUI.Flights.Core.Helpers
{
    public class FlightHelper
    {
        ...
        public double CalculateDuration(double totalDistance, double distancePerMile)
        {
            return Math.Round(totalDistance / distancePerMile, 2);
        }

        public double CalculateFuelConsumption(double totalDuration, double consumptionPerHour, double takeOffEffort)
        {
